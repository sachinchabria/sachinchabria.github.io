...
import logoBanesco from '@/images/logos/banesco.svg'
      ...
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image1, image2, image3, image4].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
              'relative w-72 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-92 sm:rounded-2xl dark:bg-zinc-800',
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Consultant, software engineer, tennis player, and photographer
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Sachin, a software engineer by education and consultant by profession.
            I am currently based in Panama City, where I work at McKinsey and serve clients
            ranging from the Panama Canal to banks looking to redesign their authentication
            and authorization procedures.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://instagram.com/sach.png"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/sachinchabria"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/sachinchhabria"
